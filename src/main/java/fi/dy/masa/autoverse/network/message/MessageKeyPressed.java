...
public class MessageKeyPressed implements IMessage
{
    ...
    public static class Handler implements IMessageHandler<MessageKeyPressed, IMessage>
    {
        ...
        public IMessage onMessage(final MessageKeyPressed message, MessageContext ctx)
        {
            ...
            {
                Autoverse.logger.error("Wrong side in MessageKeyPressed: " + ctx.side);
                return null;
            }
            ...
            {
                Autoverse.logger.error("Sending player was null in MessageKeyPressed");
                return null;
            }
            ...
            {
                Autoverse.logger.error("World was null in MessageKeyPressed");
                return null;
            }
