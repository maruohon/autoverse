...
public class GuiContainerLargeStacks extends GuiAutoverse
{
    protected final List<IItemHandler> scaledStackSizeTextInventories;

    public GuiContainerLargeStacks(ContainerAutoverse container, int xSize, int ySize, String textureName)
    {
